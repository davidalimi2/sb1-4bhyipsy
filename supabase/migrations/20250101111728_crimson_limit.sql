...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    AND policyname = 'documents_read_access_v2'
  ) THEN
    CREATE POLICY "documents_read_access_v2"
  ...
  IF NOT EXISTS (
    ...
    WHERE tablename = 'objects' 
    AND schemaname = 'storage'
    AND policyname = 'documents_write_access_v2'
  ) THEN
    CREATE POLICY "documents_write_access_v2"
  ...
  IF NOT EXISTS (
    ...
    WHERE tablename = 'objects' 
    AND schemaname = 'storage'
    AND policyname = 'documents_update_access_v2'
  ) THEN
    CREATE POLICY "documents_update_access_v2"
