...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    WHERE policyname = 'documents_read_access_v9'
    AND tablename = 'objects'
    AND schemaname = 'storage'
  ) THEN
    CREATE POLICY "documents_read_access_v9"
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE policyname = 'documents_write_access_v9'
    AND tablename = 'objects'
    AND schemaname = 'storage'
  ) THEN
    CREATE POLICY "documents_write_access_v9"
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE policyname = 'documents_update_access_v9'
    AND tablename = 'objects'
    AND schemaname = 'storage'
  ) THEN
    CREATE POLICY "documents_update_access_v9"
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE policyname = 'documents_delete_access_v9'
    AND tablename = 'objects'
    AND schemaname = 'storage'
  ) THEN
    CREATE POLICY "documents_delete_access_v9"
